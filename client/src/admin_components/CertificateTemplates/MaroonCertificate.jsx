...
const MaroonCertificate = ({
  ...
  return (
    <div
      className="relative w-full max-w-4xl mx-auto bg-gradient-to-b from-[#fff5f5] to-[#ffecec] border-4 sm:border-6 lg:border-8 border-[#800000] rounded-lg sm:rounded-xl lg:rounded-2xl shadow-xl p-3 sm:p-6 lg:p-8 text-center transition-all duration-300"
      style={{ aspectRatio: "11/8.5" }}
    >
      {/* HEADER */}
      <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-[#800000] mb-1 sm:mb-2 font-serif">
        CERTIFICATE
      </h1>
      <h2 className="text-lg sm:text-xl md:text-2xl font-semibold text-[#a52a2a] mb-3 sm:mb-4 lg:mb-6 font-serif">
        OF APPRECIATION
      </h2>
      ...
      <p className="text-gray-800 text-xs sm:text-sm md:text-base max-w-2xl mx-auto leading-relaxed px-2">
        In recognition of their invaluable contribution to{" "}
      ...
      <div className="mt-6 sm:mt-8 lg:mt-10 flex flex-wrap justify-center gap-4 sm:gap-6 lg:gap-8 xl:gap-12">
        {organizers.map((org, index) => (
          ...
          >
            ...
            <div className="border-t border-[#800000] w-16 sm:w-20 lg:w-24 my-1 sm:my-2"></div>
            ...
            {editing ? (
              <input
                ...
                className="border border-[#a52a2a] rounded-md text-center p-1 text-xs sm:text-sm mb-1 sm:mb-2 w-full focus:outline-none"
              />
            ) : (
              <p className="font-semibold text-[#800000] text-xs sm:text-sm lg:text-base text-center">{org.name}</p>
            )}
...
export default MaroonCertificate;
